                 ...
                 <div class="col-md-4">
					...
					@endif
                       ...
                       <div class="personal-details">
                        ...
                        <p class="prfl-details">{{ $user->name }}</p>
                         <p class="prfl-details">Age: {{  $age}}</p>
                        <p class="prfl-details">Religion: 
                            <?php if(empty($user->religion))
                                {echo $user->other_religion;}else {
                          echo $user->religion;
