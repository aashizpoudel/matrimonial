...
?>
   ...
   <div class="display_box" align="left">
      ...
      <li> <a href='search-profile-view/{{$sender_id}}'> <img src=" {{asset($getnoti->path)}} " style="width:50px; height:50px; float:left; margin-right:6px;" /><span class="name"><?php  echo  $getnoti->name." is interested in your profile"; ?> </a></li>
               		 </div>
